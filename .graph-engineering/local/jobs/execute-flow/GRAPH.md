...
stateDiagram-v2
    ...
    resolvingRequest --> readingFlow: READ_FLOW<br/>A single matching flow logical identifier is clearly identified<br/>Context: flow_name=matched-logical-identifier
